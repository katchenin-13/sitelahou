...
jQuery(document).ready(function(){
    jQuery(".btnRtl").on("click", function (e) {
        jQuery("#pageWrapper").removeClass("ltr").addClass("rtl");
        ...
        jQuery(".lgsImagesSlider").slick("unslick");
        ...
        jQuery(".echSlider").slick("unslick");
        jQuery(".echSlider").slick({
            ...
            rtl: true, // Add RTL option
            dotsClass:
                "dotsList dotsListii d-flex align-items-center justify-content-center list-unstyled mb-0 mt-8 mt-lg-12",
        });

        jQuery(".ibSlider").slick("unslick");
        jQuery(".ibSlider").slick({
            ...
            arrows: true,
            prevArrow:
                '<a href="#" class="slickPrev ssArrowVi rounded-circle d-flex align-items-center justify-content-center fas fa-chevron-left position-absolute"><span class="sr-only">prev</span></a>',
            nextArrow:
                '<a href="#" class="slickNext ssArrowVi rounded-circle d-flex align-items-center justify-content-center fas fa-chevron-right position-absolute"><span class="sr-only">next</span></a>',
            autoplay: true,
            fade: true,
            speed: 1300,
            adaptiveHeight: true,
            ...
            responsive: [
                {
                    ...
                    settings: {
                        ...
                        dots: true,
                        dotsClass:
                            "dotsList d-flex align-items-center justify-content-center list-unstyled mb-0",
                    },
                },
            ],
        });
    ...
    jQuery(".btnLtr").click(function () {
        jQuery("#pageWrapper").removeClass("rtl").addClass("ltr");
        jQuery("html").attr("dir", "ltr");
        // jQuery('link[href="css/rtl-bootstrap.min.css"]').remove();
	...
	function initProgressBar() {
		if( jQuery(".progress-bar").length != '' ){
			var waypoint = new Waypoint({
				element: document.getElementById('progress-bar, progress-bar1, progress-bar2'),
	...
	jQuery('.quantity-button#plus').click(function () {
		if (jQuery(this).prev().val() < 3) {
			jQuery(this).prev().val(+jQuery(this).prev().val() + 1);
		}
	});

	jQuery('.quantity-button#minus').click(function () {
...
function initSlickCarousel() {
	...
	jQuery('.testimonialSliderVii').slick({
		slidesToShow: 2,
		slidesToScroll: 1,
		arrows: false,
		dots: true,
	...
	jQuery('.scgSpeakersSlider').slick({
		...
		slidesToScroll: 3,
		dots: true,
		dotsClass: 'dotsList dotsListii d-flex align-items-center justify-content-center list-unstyled mb-0 mt-2',
		arrows: false,
		responsive: [{
			breakpoint: 992,
			settings: {
